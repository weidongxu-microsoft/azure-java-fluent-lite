...
import com.azure.resourcemanager.generated.storage.fluent.inner.FileShareItemsInner;
...
public final class FileSharesClientImpl {
    ...
    public Mono<Void> restoreAsync(
        String resourceGroupName, String accountName, String shareName, DeletedShare deletedShare, Context context) {
        return restoreWithResponseAsync(resourceGroupName, accountName, shareName, deletedShare, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void restore(
        String resourceGroupName, String accountName, String shareName, DeletedShare deletedShare, Context context) {
        restoreAsync(resourceGroupName, accountName, shareName, deletedShare, context).block();
    }
